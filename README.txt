 * 一些爬虫练手的小项目
 ...
 # 智联招聘爬虫(ZhikianCrawer)
	* 在windows环境下爬取，采取面向对象的方式编程
	* 可以在config.py中设置爬取的地方、职位、数据储存的方式
	* 获取的数据有：职位、公司名称、地点、公司性质、公司规模、所需经验、学历、职位月薪、岗位职责、岗位职责、链接
	* 获取的结果储存在txt文件或MongoDB数据库中
	* 总结：
		1、开启多进程时，存到txt文件中出现错误
		2、对多进程的原理不清楚
	* 2018-5-9
